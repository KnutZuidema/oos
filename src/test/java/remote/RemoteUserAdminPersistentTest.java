...
class RemoteUserAdminPersistentTest {
    private final String id = "id";
    private final char[] password = {'p', 'w'};
    private final String fileName = "userAdmin";
    ...
    void setUp() {
        ...
        try {
            userAdmin = new RemoteUserAdmin(fileName);
    ...
    void tearDown() {
        try {
            Files.deleteIfExists(Paths.get(fileName + ".ser"));
        } catch (IOException e) {
            fail(e);
        }
    }
